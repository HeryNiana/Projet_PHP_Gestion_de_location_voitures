...
#btn-submit:disabled{
	padding: 10px 20px;background: #CCC;border: 0;
		...
		<div class="col-md-4 col-sm-4 col-lg-4">
			...
			<form id="frm" method="post">
			   ...
			   <div class="form-group">
			        <button type="submit" class="btn btn-primary" name="btn-submit" id="btn-submit" disabled="disabled" >Se connecter</button><hr>
