...
{
$cent = substr($nombre, -6);
$reste = substr($nombre, -9);

if(strlen($milliard)==1){
		$million = substr($nombre, 1,4);
		$this->enLettre.=$this->chiffre[$milliard];
			if($milliard == 1){
				$this->enLettre.=' MILLIARD ';

			}else{
				$this->enLettre.=' MILLIARDS ';
			}
	}
		elseif(strlen($milliard) == 2){
			$million=substr($nombre,2,6);
		...
		elseif (strlen($milliard) == 3) {
			$million=substr($nombre,3,6);
		...
		elseif (strlen($milliard)==4)
		{
			$million=substr($nombre,4,6);
